...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TransactionTable.affidavit_uid_string'
        db.alter_column(u'enersectapp_transactiontable', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=63))

        # Changing field 'InternalRecord.affidavit_uid_string'
        db.alter_column(u'enersectapp_internalrecord', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=63))

        # Changing field 'SourcePdf.affidavit_uid_string'
        db.alter_column(u'enersectapp_sourcepdf', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=63))

        # Changing field 'PdfRecord.affidavit_uid_string'
        db.alter_column(u'enersectapp_pdfrecord', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=63))

        # Changing field 'BankRecord.affidavit_uid_string'
        db.alter_column(u'enersectapp_bankrecord', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=63))

    def backwards(self, orm):

        # Changing field 'TransactionTable.affidavit_uid_string'
        db.alter_column(u'enersectapp_transactiontable', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=31))

        # Changing field 'InternalRecord.affidavit_uid_string'
        db.alter_column(u'enersectapp_internalrecord', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=31))

        # Changing field 'SourcePdf.affidavit_uid_string'
        db.alter_column(u'enersectapp_sourcepdf', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=31))

        # Changing field 'PdfRecord.affidavit_uid_string'
        db.alter_column(u'enersectapp_pdfrecord', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=31))

        # Changing field 'BankRecord.affidavit_uid_string'
        db.alter_column(u'enersectapp_bankrecord', 'affidavit_uid_string', self.gf('django.db.models.fields.CharField')(max_length=31))
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
