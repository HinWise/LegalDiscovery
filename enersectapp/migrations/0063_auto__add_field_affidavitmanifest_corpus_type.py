...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AffidavitManifest.corpus_type'
        db.add_column(u'enersectapp_affidavitmanifest', 'corpus_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AffidavitManifest.corpus_type'
        db.delete_column(u'enersectapp_affidavitmanifest', 'corpus_type')
