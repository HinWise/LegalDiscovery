...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PdfRecord.record_link'
        db.alter_column(u'enersectapp_pdfrecord', 'record_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.Record'], null=True))

        # Changing field 'Record.internalrecord_link'
        db.alter_column(u'enersectapp_record', 'internalrecord_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.InternalRecord'], null=True))

    def backwards(self, orm):

        # Changing field 'PdfRecord.record_link'
        db.alter_column(u'enersectapp_pdfrecord', 'record_link_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['enersectapp.Record']))

        # Changing field 'Record.internalrecord_link'
        db.alter_column(u'enersectapp_record', 'internalrecord_link_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['enersectapp.InternalRecord']))
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
