...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.datetime_date'
        db.add_column(u'enersectapp_pdfrecord', 'datetime_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Record.datetime_date'
        db.add_column(u'enersectapp_record', 'datetime_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.datetime_date'
        db.delete_column(u'enersectapp_pdfrecord', 'datetime_date')

        # Deleting field 'Record.datetime_date'
        db.delete_column(u'enersectapp_record', 'datetime_date')
