...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourcePdf.Amount'
        db.add_column(u'enersectapp_sourcepdf', 'Amount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'SourcePdf.Piece_Number'
        db.add_column(u'enersectapp_sourcepdf', 'Piece_Number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'SourcePdf.AmountBeforeManifest'
        db.add_column(u'enersectapp_sourcepdf', 'AmountBeforeManifest',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'SourcePdf.Piece_NumberBeforeManifest'
        db.add_column(u'enersectapp_sourcepdf', 'Piece_NumberBeforeManifest',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourcePdf.Amount'
        db.delete_column(u'enersectapp_sourcepdf', 'Amount')

        # Deleting field 'SourcePdf.Piece_Number'
        db.delete_column(u'enersectapp_sourcepdf', 'Piece_Number')

        # Deleting field 'SourcePdf.AmountBeforeManifest'
        db.delete_column(u'enersectapp_sourcepdf', 'AmountBeforeManifest')

        # Deleting field 'SourcePdf.Piece_NumberBeforeManifest'
        db.delete_column(u'enersectapp_sourcepdf', 'Piece_NumberBeforeManifest')
    ...
    models = {
        ...
        u'enersectapp.sourcepdf': {
            'Amount': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '63'}),
            'AmountBeforeManifest': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '63'}),
            'Beneficiary': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '63'}),
            ...
            'Piece_Number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '63'}),
            'Piece_NumberBeforeManifest': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '63'}),
