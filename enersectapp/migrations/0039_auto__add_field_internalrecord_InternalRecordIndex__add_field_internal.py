...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InternalRecord.InternalRecordIndex'
        db.add_column(u'enersectapp_internalrecord', 'InternalRecordIndex',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'InternalRecord.BestTransactionMatch'
        db.add_column(u'enersectapp_internalrecord', 'BestTransactionMatch',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InternalRecord.DateDiscrepancy'
        db.add_column(u'enersectapp_internalrecord', 'DateDiscrepancy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'InternalRecord.MEDollars'
        db.add_column(u'enersectapp_internalrecord', 'MEDollars',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEPounds'
        db.add_column(u'enersectapp_internalrecord', 'MEPounds',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEEuros'
        db.add_column(u'enersectapp_internalrecord', 'MEEuros',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEChequeNum'
        db.add_column(u'enersectapp_internalrecord', 'MEChequeNum',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MECategory'
        db.add_column(u'enersectapp_internalrecord', 'MECategory',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEDate'
        db.add_column(u'enersectapp_internalrecord', 'MEDate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MECutoff'
        db.add_column(u'enersectapp_internalrecord', 'MECutoff',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEFactureNum'
        db.add_column(u'enersectapp_internalrecord', 'MEFactureNum',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.ExchangeRate'
        db.add_column(u'enersectapp_internalrecord', 'ExchangeRate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.ExistingBankEntry'
        db.add_column(u'enersectapp_internalrecord', 'ExistingBankEntry',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.BankAccount'
        db.add_column(u'enersectapp_internalrecord', 'BankAccount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.BankName'
        db.add_column(u'enersectapp_internalrecord', 'BankName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.BankCurrency'
        db.add_column(u'enersectapp_internalrecord', 'BankCurrency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InternalRecord.InternalRecordIndex'
        db.delete_column(u'enersectapp_internalrecord', 'InternalRecordIndex')

        # Deleting field 'InternalRecord.BestTransactionMatch'
        db.delete_column(u'enersectapp_internalrecord', 'BestTransactionMatch')

        # Deleting field 'InternalRecord.DateDiscrepancy'
        db.delete_column(u'enersectapp_internalrecord', 'DateDiscrepancy')

        # Deleting field 'InternalRecord.MEDollars'
        db.delete_column(u'enersectapp_internalrecord', 'MEDollars')

        # Deleting field 'InternalRecord.MEPounds'
        db.delete_column(u'enersectapp_internalrecord', 'MEPounds')

        # Deleting field 'InternalRecord.MEEuros'
        db.delete_column(u'enersectapp_internalrecord', 'MEEuros')

        # Deleting field 'InternalRecord.MEChequeNum'
        db.delete_column(u'enersectapp_internalrecord', 'MEChequeNum')

        # Deleting field 'InternalRecord.MECategory'
        db.delete_column(u'enersectapp_internalrecord', 'MECategory')

        # Deleting field 'InternalRecord.MEDate'
        db.delete_column(u'enersectapp_internalrecord', 'MEDate')

        # Deleting field 'InternalRecord.MECutoff'
        db.delete_column(u'enersectapp_internalrecord', 'MECutoff')

        # Deleting field 'InternalRecord.MEFactureNum'
        db.delete_column(u'enersectapp_internalrecord', 'MEFactureNum')

        # Deleting field 'InternalRecord.ExchangeRate'
        db.delete_column(u'enersectapp_internalrecord', 'ExchangeRate')

        # Deleting field 'InternalRecord.ExistingBankEntry'
        db.delete_column(u'enersectapp_internalrecord', 'ExistingBankEntry')

        # Deleting field 'InternalRecord.BankAccount'
        db.delete_column(u'enersectapp_internalrecord', 'BankAccount')

        # Deleting field 'InternalRecord.BankName'
        db.delete_column(u'enersectapp_internalrecord', 'BankName')

        # Deleting field 'InternalRecord.BankCurrency'
        db.delete_column(u'enersectapp_internalrecord', 'BankCurrency')
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
