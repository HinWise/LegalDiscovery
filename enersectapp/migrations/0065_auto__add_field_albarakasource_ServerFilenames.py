...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbarakaSource.ServerFilenames'
        db.add_column(u'enersectapp_albarakasource', 'ServerFilenames',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbarakaSource.ServerFilenames'
        db.delete_column(u'enersectapp_albarakasource', 'ServerFilenames')
