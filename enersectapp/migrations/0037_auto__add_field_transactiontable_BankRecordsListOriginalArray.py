...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionTable.BankRecordsListOriginalArray'
        db.add_column(u'enersectapp_transactiontable', 'BankRecordsListOriginalArray',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransactionTable.BankRecordsListOriginalArray'
        db.delete_column(u'enersectapp_transactiontable', 'BankRecordsListOriginalArray')
    ...
    models = {
        ...
        u'enersectapp.transactiontable': {
            'BankRecordsListOriginalArray': ('django.db.models.fields.CharField', [], {'max_length': '63'}),
