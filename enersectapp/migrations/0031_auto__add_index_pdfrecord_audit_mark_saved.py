...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PdfRecord', fields ['audit_mark_saved']
        db.create_index(u'enersectapp_pdfrecord', ['audit_mark_saved'])


    def backwards(self, orm):
        # Removing index on 'PdfRecord', fields ['audit_mark_saved']
        db.delete_index(u'enersectapp_pdfrecord', ['audit_mark_saved'])
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'audit_mark_saved': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '512', 'db_index': 'True'}),
