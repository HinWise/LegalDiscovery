...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.modified_doctype'
        db.add_column(u'enersectapp_pdfrecord', 'modified_doctype',
                      self.gf('django.db.models.fields.CharField')(default='uncategorized', max_length=255),
                      keep_default=False)

        # Adding field 'SourcePdf.multipart_num_total'
        db.add_column(u'enersectapp_sourcepdf', 'multipart_num_total',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=255),
                      keep_default=False)

        # Adding field 'SourcePdf.multipart_filename'
        db.add_column(u'enersectapp_sourcepdf', 'multipart_filename',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=255),
                      keep_default=False)

        # Adding field 'SourcePdf.corrupt'
        db.add_column(u'enersectapp_sourcepdf', 'corrupt',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.modified_doctype'
        db.delete_column(u'enersectapp_pdfrecord', 'modified_doctype')

        # Deleting field 'SourcePdf.multipart_num_total'
        db.delete_column(u'enersectapp_sourcepdf', 'multipart_num_total')

        # Deleting field 'SourcePdf.multipart_filename'
        db.delete_column(u'enersectapp_sourcepdf', 'multipart_filename')

        # Deleting field 'SourcePdf.corrupt'
        db.delete_column(u'enersectapp_sourcepdf', 'corrupt')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 6, 0, 0)'}),
