...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AffidavitInstance'
        db.create_table(u'enersectapp_affidavitinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('watermark_name', self.gf('django.db.models.fields.CharField')(default='00000000', max_length=7)),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 20, 0, 0))),
        ))
        db.send_create_signal(u'enersectapp', ['AffidavitInstance'])

        # Adding field 'TransactionTable.actual_affidavit_watermark'
        db.add_column(u'enersectapp_transactiontable', 'actual_affidavit_watermark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TransactionTable.affidavit_watermark_string'
        db.add_column(u'enersectapp_transactiontable', 'affidavit_watermark_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=7),
                      keep_default=False)

        # Adding field 'InternalRecord.actual_affidavit_watermark'
        db.add_column(u'enersectapp_internalrecord', 'actual_affidavit_watermark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'InternalRecord.affidavit_watermark_string'
        db.add_column(u'enersectapp_internalrecord', 'affidavit_watermark_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=7),
                      keep_default=False)

        # Adding field 'SourcePdf.actual_affidavit_watermark'
        db.add_column(u'enersectapp_sourcepdf', 'actual_affidavit_watermark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SourcePdf.affidavit_watermark_string'
        db.add_column(u'enersectapp_sourcepdf', 'affidavit_watermark_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=7),
                      keep_default=False)

        # Adding field 'PdfRecord.actual_affidavit_watermark'
        db.add_column(u'enersectapp_pdfrecord', 'actual_affidavit_watermark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PdfRecord.affidavit_watermark_string'
        db.add_column(u'enersectapp_pdfrecord', 'affidavit_watermark_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=7),
                      keep_default=False)

        # Adding field 'BankRecord.actual_affidavit_watermark'
        db.add_column(u'enersectapp_bankrecord', 'actual_affidavit_watermark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BankRecord.affidavit_watermark_string'
        db.add_column(u'enersectapp_bankrecord', 'affidavit_watermark_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AffidavitInstance'
        db.delete_table(u'enersectapp_affidavitinstance')

        # Deleting field 'TransactionTable.actual_affidavit_watermark'
        db.delete_column(u'enersectapp_transactiontable', 'actual_affidavit_watermark_id')

        # Deleting field 'TransactionTable.affidavit_watermark_string'
        db.delete_column(u'enersectapp_transactiontable', 'affidavit_watermark_string')

        # Deleting field 'InternalRecord.actual_affidavit_watermark'
        db.delete_column(u'enersectapp_internalrecord', 'actual_affidavit_watermark_id')

        # Deleting field 'InternalRecord.affidavit_watermark_string'
        db.delete_column(u'enersectapp_internalrecord', 'affidavit_watermark_string')

        # Deleting field 'SourcePdf.actual_affidavit_watermark'
        db.delete_column(u'enersectapp_sourcepdf', 'actual_affidavit_watermark_id')

        # Deleting field 'SourcePdf.affidavit_watermark_string'
        db.delete_column(u'enersectapp_sourcepdf', 'affidavit_watermark_string')

        # Deleting field 'PdfRecord.actual_affidavit_watermark'
        db.delete_column(u'enersectapp_pdfrecord', 'actual_affidavit_watermark_id')

        # Deleting field 'PdfRecord.affidavit_watermark_string'
        db.delete_column(u'enersectapp_pdfrecord', 'affidavit_watermark_string')

        # Deleting field 'BankRecord.actual_affidavit_watermark'
        db.delete_column(u'enersectapp_bankrecord', 'actual_affidavit_watermark_id')

        # Deleting field 'BankRecord.affidavit_watermark_string'
        db.delete_column(u'enersectapp_bankrecord', 'affidavit_watermark_string')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
