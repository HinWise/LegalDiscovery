...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InternalRecord.MELedgerPage'
        db.add_column(u'enersectapp_internalrecord', 'MELedgerPage',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MELedgerSize'
        db.add_column(u'enersectapp_internalrecord', 'MELedgerSize',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.Filename'
        db.add_column(u'enersectapp_internalrecord', 'Filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'InternalRecord.BankEntry'
        db.add_column(u'enersectapp_internalrecord', 'BankEntry',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InternalRecord.MELedgerPage'
        db.delete_column(u'enersectapp_internalrecord', 'MELedgerPage')

        # Deleting field 'InternalRecord.MELedgerSize'
        db.delete_column(u'enersectapp_internalrecord', 'MELedgerSize')

        # Deleting field 'InternalRecord.Filename'
        db.delete_column(u'enersectapp_internalrecord', 'Filename')

        # Deleting field 'InternalRecord.BankEntry'
        db.delete_column(u'enersectapp_internalrecord', 'BankEntry')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
