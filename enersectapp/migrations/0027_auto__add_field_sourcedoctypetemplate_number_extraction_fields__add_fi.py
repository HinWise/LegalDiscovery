...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDocTypeTemplate.number_extraction_fields'
        db.add_column(u'enersectapp_sourcedoctypetemplate', 'number_extraction_fields',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SourceDocType.number_extraction_fields'
        db.add_column(u'enersectapp_sourcedoctype', 'number_extraction_fields',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDocTypeTemplate.number_extraction_fields'
        db.delete_column(u'enersectapp_sourcedoctypetemplate', 'number_extraction_fields')

        # Deleting field 'SourceDocType.number_extraction_fields'
        db.delete_column(u'enersectapp_sourcedoctype', 'number_extraction_fields')
