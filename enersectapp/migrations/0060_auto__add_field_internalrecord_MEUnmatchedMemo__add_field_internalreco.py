...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InternalRecord.MEUnmatchedMemo'
        db.add_column(u'enersectapp_internalrecord', 'MEUnmatchedMemo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEMatchedMemo'
        db.add_column(u'enersectapp_internalrecord', 'MEMatchedMemo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MESourceAmount'
        db.add_column(u'enersectapp_internalrecord', 'MESourceAmount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'InternalRecord.MECurrency'
        db.add_column(u'enersectapp_internalrecord', 'MECurrency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MECorrection'
        db.add_column(u'enersectapp_internalrecord', 'MECorrection',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.Materials'
        db.add_column(u'enersectapp_internalrecord', 'Materials',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'InternalRecord.MismatchAndNotCutoff'
        db.add_column(u'enersectapp_internalrecord', 'MismatchAndNotCutoff',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'InternalRecord.MEActualExchangeRate'
        db.add_column(u'enersectapp_internalrecord', 'MEActualExchangeRate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.MEExchangeRateMistmatch'
        db.add_column(u'enersectapp_internalrecord', 'MEExchangeRateMistmatch',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InternalRecord.MEUnmatchedMemo'
        db.delete_column(u'enersectapp_internalrecord', 'MEUnmatchedMemo')

        # Deleting field 'InternalRecord.MEMatchedMemo'
        db.delete_column(u'enersectapp_internalrecord', 'MEMatchedMemo')

        # Deleting field 'InternalRecord.MESourceAmount'
        db.delete_column(u'enersectapp_internalrecord', 'MESourceAmount')

        # Deleting field 'InternalRecord.MECurrency'
        db.delete_column(u'enersectapp_internalrecord', 'MECurrency')

        # Deleting field 'InternalRecord.MECorrection'
        db.delete_column(u'enersectapp_internalrecord', 'MECorrection')

        # Deleting field 'InternalRecord.Materials'
        db.delete_column(u'enersectapp_internalrecord', 'Materials')

        # Deleting field 'InternalRecord.MismatchAndNotCutoff'
        db.delete_column(u'enersectapp_internalrecord', 'MismatchAndNotCutoff')

        # Deleting field 'InternalRecord.MEActualExchangeRate'
        db.delete_column(u'enersectapp_internalrecord', 'MEActualExchangeRate')

        # Deleting field 'InternalRecord.MEExchangeRateMistmatch'
        db.delete_column(u'enersectapp_internalrecord', 'MEExchangeRateMistmatch')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
        ...
        u'enersectapp.internalrecord': {
            ...
            'ExistingBankEntry': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '31'}),
            'Filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '63'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
