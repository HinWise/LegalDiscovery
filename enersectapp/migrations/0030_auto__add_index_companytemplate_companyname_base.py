...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CompanyTemplate', fields ['companyname_base']
        db.create_index(u'enersectapp_companytemplate', ['companyname_base'])


    def backwards(self, orm):
        # Removing index on 'CompanyTemplate', fields ['companyname_base']
        db.delete_index(u'enersectapp_companytemplate', ['companyname_base'])
