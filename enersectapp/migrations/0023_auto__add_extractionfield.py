...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtractionField'
        db.create_table(u'enersectapp_extractionfield', (
        ...
        db.send_create_signal(u'enersectapp', ['ExtractionField'])

        # Adding M2M table for field extraction_fields on 'SourceDocType'
        m2m_table_name = db.shorten_name(u'enersectapp_sourcedoctype_extraction_fields')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sourcedoctype', models.ForeignKey(orm[u'enersectapp.sourcedoctype'], null=False)),
            ('extractionfield', models.ForeignKey(orm[u'enersectapp.extractionfield'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sourcedoctype_id', 'extractionfield_id'])


    def backwards(self, orm):
        # Deleting model 'ExtractionField'
        db.delete_table(u'enersectapp_extractionfield')

        # Removing M2M table for field extraction_fields on 'SourceDocType'
        db.delete_table(db.shorten_name(u'enersectapp_sourcedoctype_extraction_fields'))
    ...
    models = {
        ...
        u'enersectapp.extractionfield': {
            'Meta': {'object_name': 'ExtractionField'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 14, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 14, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 14, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 14, 0, 0)'}),
