...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.EntryByCompany'
        db.add_column(u'enersectapp_pdfrecord', 'EntryByCompany',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PdfRecord.EntryAuthor'
        db.add_column(u'enersectapp_pdfrecord', 'EntryAuthor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PdfRecord.AssignedLotNumber'
        db.add_column(u'enersectapp_pdfrecord', 'AssignedLotNumber',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.LotNumber'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.EntryByCompany'
        db.delete_column(u'enersectapp_pdfrecord', 'EntryByCompany_id')

        # Deleting field 'PdfRecord.EntryAuthor'
        db.delete_column(u'enersectapp_pdfrecord', 'EntryAuthor_id')

        # Deleting field 'PdfRecord.AssignedLotNumber'
        db.delete_column(u'enersectapp_pdfrecord', 'AssignedLotNumber_id')
