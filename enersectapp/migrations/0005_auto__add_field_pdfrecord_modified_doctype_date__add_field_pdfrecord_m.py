...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.modified_doctype_date'
        db.add_column(u'enersectapp_pdfrecord', 'modified_doctype_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'PdfRecord.modified_doctype_author'
        db.add_column(u'enersectapp_pdfrecord', 'modified_doctype_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SourcePdf.modified_doctype'
        db.add_column(u'enersectapp_sourcepdf', 'modified_doctype',
                      self.gf('django.db.models.fields.CharField')(default='uncategorized', max_length=255),
                      keep_default=False)

        # Adding field 'SourcePdf.modification_doctype_date'
        db.add_column(u'enersectapp_sourcepdf', 'modification_doctype_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'SourcePdf.modification_doctype_author'
        db.add_column(u'enersectapp_sourcepdf', 'modification_doctype_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.modified_doctype_date'
        db.delete_column(u'enersectapp_pdfrecord', 'modified_doctype_date')

        # Deleting field 'PdfRecord.modified_doctype_author'
        db.delete_column(u'enersectapp_pdfrecord', 'modified_doctype_author_id')

        # Deleting field 'SourcePdf.modified_doctype'
        db.delete_column(u'enersectapp_sourcepdf', 'modified_doctype')

        # Deleting field 'SourcePdf.modification_doctype_date'
        db.delete_column(u'enersectapp_sourcepdf', 'modification_doctype_date')

        # Deleting field 'SourcePdf.modification_doctype_author'
        db.delete_column(u'enersectapp_sourcepdf', 'modification_doctype_author_id')
