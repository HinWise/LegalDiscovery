...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table(u'enersectapp_report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report_type', self.gf('django.db.models.fields.CharField')(default='None', max_length=31)),
            ('report_memo', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('report_author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('report_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('report_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 21, 0, 0))),
            ('report_viewed', self.gf('django.db.models.fields.CharField')(default='No', max_length=7)),
        ))
        db.send_create_signal(u'enersectapp', ['Report'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table(u'enersectapp_report')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)'}),
