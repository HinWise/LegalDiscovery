...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'enersectapp_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'enersectapp', ['UserProfile'])

        # Adding M2M table for field modifiedsourcepdfs_categorization_tool on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedsourcepdfs_categorization_tool')
        ...
        db.create_unique(m2m_table_name, ['userprofile_id', 'sourcepdf_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'enersectapp_userprofile')

        # Removing M2M table for field modifiedsourcepdfs_categorization_tool on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedsourcepdfs_categorization_tool'))
    ...
    models = {
        ...
        u'enersectapp.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedpdfs_blank_or_not_tool': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': u"orm['enersectapp.PdfRecord']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
