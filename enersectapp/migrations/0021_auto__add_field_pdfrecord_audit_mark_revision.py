...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.audit_mark_revision'
        db.add_column(u'enersectapp_pdfrecord', 'audit_mark_revision',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.audit_mark_revision'
        db.delete_column(u'enersectapp_pdfrecord', 'audit_mark_revision')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
