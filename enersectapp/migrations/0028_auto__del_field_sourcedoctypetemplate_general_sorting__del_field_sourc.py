...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceDocTypeTemplate.general_sorting'
        db.delete_column(u'enersectapp_sourcedoctypetemplate', 'general_sorting')

        # Deleting field 'SourceDocType.general_sorting'
        db.delete_column(u'enersectapp_sourcedoctype', 'general_sorting')

        # Adding field 'LegalDiscoveryTemplate.general_sorting'
        db.add_column(u'enersectapp_legaldiscoverytemplate', 'general_sorting',
                      self.gf('django.db.models.fields.CharField')(default='modification_date', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SourceDocTypeTemplate.general_sorting'
        db.add_column(u'enersectapp_sourcedoctypetemplate', 'general_sorting',
                      self.gf('django.db.models.fields.CharField')(default='modification_date', max_length=31),
                      keep_default=False)
        ...
        # Deleting field 'LegalDiscoveryTemplate.general_sorting'
        db.delete_column(u'enersectapp_legaldiscoverytemplate', 'general_sorting')
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'})
        },
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 0, 0)'}),
