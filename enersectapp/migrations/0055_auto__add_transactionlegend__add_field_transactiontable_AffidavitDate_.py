...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransactionLegend'
        db.create_table(u'enersectapp_transactionlegend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ReferenceType', self.gf('django.db.models.fields.CharField')(default='', max_length=31)),
            ('StringNoException', self.gf('django.db.models.fields.CharField')(default='', max_length=31)),
            ('StringWithException', self.gf('django.db.models.fields.CharField')(default='', max_length=31)),
            ('IncludeListReferenceDocuments', self.gf('django.db.models.fields.CharField')(default='No', max_length=15)),
            ('ConditionalRule', self.gf('django.db.models.fields.CharField')(default='No', max_length=15)),
        ))
        db.send_create_signal(u'enersectapp', ['TransactionLegend'])

        # Adding field 'TransactionTable.AffidavitDate'
        db.add_column(u'enersectapp_transactiontable', 'AffidavitDate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'TransactionTable.AffidavitAmount'
        db.add_column(u'enersectapp_transactiontable', 'AffidavitAmount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'TransactionTable.AffidavitBeneficiary'
        db.add_column(u'enersectapp_transactiontable', 'AffidavitBeneficiary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'TransactionTable.AffidavitString'
        db.add_column(u'enersectapp_transactiontable', 'AffidavitString',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TransactionLegend'
        db.delete_table(u'enersectapp_transactionlegend')

        # Deleting field 'TransactionTable.AffidavitDate'
        db.delete_column(u'enersectapp_transactiontable', 'AffidavitDate')

        # Deleting field 'TransactionTable.AffidavitAmount'
        db.delete_column(u'enersectapp_transactiontable', 'AffidavitAmount')

        # Deleting field 'TransactionTable.AffidavitBeneficiary'
        db.delete_column(u'enersectapp_transactiontable', 'AffidavitBeneficiary')

        # Deleting field 'TransactionTable.AffidavitString'
        db.delete_column(u'enersectapp_transactiontable', 'AffidavitString')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
