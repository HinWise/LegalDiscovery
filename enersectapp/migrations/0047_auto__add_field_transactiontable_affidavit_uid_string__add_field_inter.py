...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionTable.affidavit_uid_string'
        db.add_column(u'enersectapp_transactiontable', 'affidavit_uid_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=31),
                      keep_default=False)

        # Adding field 'InternalRecord.affidavit_uid_string'
        db.add_column(u'enersectapp_internalrecord', 'affidavit_uid_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=31),
                      keep_default=False)

        # Adding field 'SourcePdf.affidavit_uid_string'
        db.add_column(u'enersectapp_sourcepdf', 'affidavit_uid_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=31),
                      keep_default=False)

        # Adding field 'PdfRecord.affidavit_uid_string'
        db.add_column(u'enersectapp_pdfrecord', 'affidavit_uid_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=31),
                      keep_default=False)

        # Adding field 'BankRecord.affidavit_uid_string'
        db.add_column(u'enersectapp_bankrecord', 'affidavit_uid_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransactionTable.affidavit_uid_string'
        db.delete_column(u'enersectapp_transactiontable', 'affidavit_uid_string')

        # Deleting field 'InternalRecord.affidavit_uid_string'
        db.delete_column(u'enersectapp_internalrecord', 'affidavit_uid_string')

        # Deleting field 'SourcePdf.affidavit_uid_string'
        db.delete_column(u'enersectapp_sourcepdf', 'affidavit_uid_string')

        # Deleting field 'PdfRecord.affidavit_uid_string'
        db.delete_column(u'enersectapp_pdfrecord', 'affidavit_uid_string')

        # Deleting field 'BankRecord.affidavit_uid_string'
        db.delete_column(u'enersectapp_bankrecord', 'affidavit_uid_string')
    ...
    models = {
        ...
        u'enersectapp.bankrecord': {
            ...
            'affidavit_uid_string': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '31'}),
