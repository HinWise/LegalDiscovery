...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlbarakaSource'
        db.create_table(u'enersectapp_albarakasource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('AlbarakaSourceIndex', self.gf('django.db.models.fields.IntegerField')()),
            ('PagesOriginalArrayString', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('FirstPage', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
            ('Document_Type', self.gf('django.db.models.fields.CharField')(default='', max_length=15)),
            ('Doc_ID_Num_Cheque', self.gf('django.db.models.fields.CharField')(default='', max_length=15)),
            ('Doc_ID_Num_Invoice', self.gf('django.db.models.fields.CharField')(default='', max_length=31)),
            ('Beneficiary', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('Signed_By', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('Day', self.gf('django.db.models.fields.CharField')(default='', max_length=3)),
            ('Month', self.gf('django.db.models.fields.CharField')(default='', max_length=3)),
            ('Year', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
            ('CompleteDate', self.gf('django.db.models.fields.CharField')(default='', max_length=15)),
            ('Amount', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
            ('Currency', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
            ('StringAmount', self.gf('django.db.models.fields.CharField')(default='', max_length=15)),
            ('Description', self.gf('django.db.models.fields.CharField')(default='', max_length=63)),
            ('PageMarking', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
            ('Filename', self.gf('django.db.models.fields.CharField')(default='', max_length=63)),
            ('FilenameUnclean', self.gf('django.db.models.fields.CharField')(default='', max_length=63)),
            ('Flagged', self.gf('django.db.models.fields.CharField')(default='no', max_length=63)),
            ('Entered_By', self.gf('django.db.models.fields.CharField')(default='', max_length=3)),
            ('actual_affidavit_watermark', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True)),
            ('affidavit_watermark_string', self.gf('django.db.models.fields.CharField')(default='None', max_length=7)),
            ('affidavit_uid_string', self.gf('django.db.models.fields.CharField')(default='None', max_length=63)),
        ))
        db.send_create_signal(u'enersectapp', ['AlbarakaSource'])

        # Adding field 'TransactionTable.AlbarakaSourceListOriginalArray'
        db.add_column(u'enersectapp_transactiontable', 'AlbarakaSourceListOriginalArray',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)

        # Adding field 'TransactionTable.NumberAlbarakaSourceIndexes'
        db.add_column(u'enersectapp_transactiontable', 'NumberAlbarakaSourceIndexes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TransactionTable.OcrRecordListOriginalArray'
        db.add_column(u'enersectapp_transactiontable', 'OcrRecordListOriginalArray',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)

        # Adding field 'TransactionTable.NumberOcrRecordIndexes'
        db.add_column(u'enersectapp_transactiontable', 'NumberOcrRecordIndexes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field albarakasource_records_list on 'TransactionTable'
        m2m_table_name = db.shorten_name(u'enersectapp_transactiontable_albarakasource_records_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False)),
            ('albarakasource', models.ForeignKey(orm[u'enersectapp.albarakasource'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transactiontable_id', 'albarakasource_id'])

        # Adding M2M table for field ocr_records_list on 'TransactionTable'
        m2m_table_name = db.shorten_name(u'enersectapp_transactiontable_ocr_records_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False)),
            ('ocrrecord', models.ForeignKey(orm[u'enersectapp.ocrrecord'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transactiontable_id', 'ocrrecord_id'])


    def backwards(self, orm):
        # Deleting model 'AlbarakaSource'
        db.delete_table(u'enersectapp_albarakasource')

        # Deleting field 'TransactionTable.AlbarakaSourceListOriginalArray'
        db.delete_column(u'enersectapp_transactiontable', 'AlbarakaSourceListOriginalArray')

        # Deleting field 'TransactionTable.NumberAlbarakaSourceIndexes'
        db.delete_column(u'enersectapp_transactiontable', 'NumberAlbarakaSourceIndexes')

        # Deleting field 'TransactionTable.OcrRecordListOriginalArray'
        db.delete_column(u'enersectapp_transactiontable', 'OcrRecordListOriginalArray')

        # Deleting field 'TransactionTable.NumberOcrRecordIndexes'
        db.delete_column(u'enersectapp_transactiontable', 'NumberOcrRecordIndexes')

        # Removing M2M table for field albarakasource_records_list on 'TransactionTable'
        db.delete_table(db.shorten_name(u'enersectapp_transactiontable_albarakasource_records_list'))

        # Removing M2M table for field ocr_records_list on 'TransactionTable'
        db.delete_table(db.shorten_name(u'enersectapp_transactiontable_ocr_records_list'))
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 0, 0)'}),
        ...
        u'enersectapp.albarakasource': {
            ...
            'Document_Type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '15'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 0, 0)'}),
