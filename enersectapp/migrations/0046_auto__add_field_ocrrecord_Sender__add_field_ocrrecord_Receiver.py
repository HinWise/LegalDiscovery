...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OcrRecord.Sender'
        db.add_column(u'enersectapp_ocrrecord', 'Sender',
                      self.gf('django.db.models.fields.CharField')(default='NoSenderField', max_length=255),
                      keep_default=False)

        # Adding field 'OcrRecord.Receiver'
        db.add_column(u'enersectapp_ocrrecord', 'Receiver',
                      self.gf('django.db.models.fields.CharField')(default='NoReceiverField', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OcrRecord.Sender'
        db.delete_column(u'enersectapp_ocrrecord', 'Sender')

        # Deleting field 'OcrRecord.Receiver'
        db.delete_column(u'enersectapp_ocrrecord', 'Receiver')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 30, 0, 0)'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 30, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 30, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 30, 0, 0)'}),
