...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionTable.BankRecordsUIDArray'
        db.add_column(u'enersectapp_transactiontable', 'BankRecordsUIDArray',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2047),
                      keep_default=False)

        # Adding field 'TransactionTable.InternalRecordUIDArray'
        db.add_column(u'enersectapp_transactiontable', 'InternalRecordUIDArray',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2047),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransactionTable.BankRecordsUIDArray'
        db.delete_column(u'enersectapp_transactiontable', 'BankRecordsUIDArray')

        # Deleting field 'TransactionTable.InternalRecordUIDArray'
        db.delete_column(u'enersectapp_transactiontable', 'InternalRecordUIDArray')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
