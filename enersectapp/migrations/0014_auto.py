...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field modifiedpdfs_categorization_tool on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_categorization_tool')
    ...
    def backwards(self, orm):
        # Removing M2M table for field modifiedpdfs_categorization_tool on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_categorization_tool'))
