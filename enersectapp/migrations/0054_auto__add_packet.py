...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Packet'
        db.create_table(u'enersectapp_packet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('PacketLabel', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('MultipartFilenameStub', self.gf('django.db.models.fields.CharField')(default='', max_length=63)),
            ('NumPackets', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('MaxPages', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('FromPage', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('ToPage', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('Description', self.gf('django.db.models.fields.CharField')(default='', max_length=63)),
        ))
        db.send_create_signal(u'enersectapp', ['Packet'])


    def backwards(self, orm):
        # Deleting model 'Packet'
        db.delete_table(u'enersectapp_packet')
