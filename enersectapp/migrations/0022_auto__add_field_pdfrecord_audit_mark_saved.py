...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.audit_mark_saved'
        db.add_column(u'enersectapp_pdfrecord', 'audit_mark_saved',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=512),
                      keep_default=False)

        # Adding M2M table for field modifiedpdfs_audit_marked on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_audit_marked')
        ...
        # Adding M2M table for field modifiedpdfs_audit_saved on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_audit_saved')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'enersectapp.userprofile'], null=False)),
            ('pdfrecord', models.ForeignKey(orm[u'enersectapp.pdfrecord'], null=False))
        ...
        # Adding M2M table for field modifiedpdfs_audit_revision on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_audit_revision')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'enersectapp.userprofile'], null=False)),
            ('pdfrecord', models.ForeignKey(orm[u'enersectapp.pdfrecord'], null=False))
    ...
    def backwards(self, orm):
        # Deleting field 'PdfRecord.audit_mark_saved'
        db.delete_column(u'enersectapp_pdfrecord', 'audit_mark_saved')

        # Removing M2M table for field modifiedpdfs_audit_marked on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_audit_marked'))

        # Removing M2M table for field modifiedpdfs_audit_saved on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_audit_saved'))

        # Removing M2M table for field modifiedpdfs_audit_revision on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_audit_revision'))
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'}),
