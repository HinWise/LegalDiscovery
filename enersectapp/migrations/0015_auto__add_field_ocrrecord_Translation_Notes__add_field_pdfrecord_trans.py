...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OcrRecord.Translation_Notes'
        db.add_column(u'enersectapp_ocrrecord', 'Translation_Notes',
                      self.gf('django.db.models.fields.CharField')(default='NoTranslationField', max_length=255),
                      keep_default=False)

        # Adding M2M table for field modifiedpdfs_translated_arabic on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_translated_arabic')
        ...
        # Adding field 'PdfRecord.translated'
        db.add_column(u'enersectapp_pdfrecord', 'translated',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OcrRecord.Translation_Notes'
        db.delete_column(u'enersectapp_ocrrecord', 'Translation_Notes')

        # Removing M2M table for field modifiedpdfs_translated_arabic on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedpdfs_translated_arabic'))

        # Deleting field 'PdfRecord.translated'
        db.delete_column(u'enersectapp_pdfrecord', 'translated')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 0, 0)'}),
