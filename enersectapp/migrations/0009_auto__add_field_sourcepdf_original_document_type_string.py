...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourcePdf.original_document_type_string'
        db.add_column(u'enersectapp_sourcepdf', 'original_document_type_string',
                      self.gf('django.db.models.fields.CharField')(default='No change', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourcePdf.original_document_type_string'
        db.delete_column(u'enersectapp_sourcepdf', 'original_document_type_string')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),
