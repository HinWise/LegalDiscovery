...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OcrRecord.CompanyLineIndexInteger'
        db.delete_column(u'enersectapp_ocrrecord', 'CompanyLineIndexInteger')

        # Adding field 'OcrRecord.SecondVersionCompanyLine'
        db.add_column(u'enersectapp_ocrrecord', 'SecondVersionCompanyLine',
                      self.gf('django.db.models.fields.CharField')(default='MISSING NAME', max_length=255),
                      keep_default=False)

        # Adding field 'OcrRecord.OldCompanyLineIndexInteger'
        db.add_column(u'enersectapp_ocrrecord', 'OldCompanyLineIndexInteger',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'OcrRecord.SecondVersionCompanyLineIndexInteger'
        db.add_column(u'enersectapp_ocrrecord', 'SecondVersionCompanyLineIndexInteger',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'OcrRecord.CompanyLineIndexInteger'
        db.add_column(u'enersectapp_ocrrecord', 'CompanyLineIndexInteger',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'OcrRecord.SecondVersionCompanyLine'
        db.delete_column(u'enersectapp_ocrrecord', 'SecondVersionCompanyLine')

        # Deleting field 'OcrRecord.OldCompanyLineIndexInteger'
        db.delete_column(u'enersectapp_ocrrecord', 'OldCompanyLineIndexInteger')

        # Deleting field 'OcrRecord.SecondVersionCompanyLineIndexInteger'
        db.delete_column(u'enersectapp_ocrrecord', 'SecondVersionCompanyLineIndexInteger')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
