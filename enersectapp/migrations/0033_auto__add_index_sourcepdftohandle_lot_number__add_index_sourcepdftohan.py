...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SourcePdfToHandle', fields ['lot_number']
        db.create_index(u'enersectapp_sourcepdftohandle', ['lot_number'])

        # Adding index on 'SourcePdfToHandle', fields ['checked']
        db.create_index(u'enersectapp_sourcepdftohandle', ['checked'])


    def backwards(self, orm):
        # Removing index on 'SourcePdfToHandle', fields ['checked']
        db.delete_index(u'enersectapp_sourcepdftohandle', ['checked'])

        # Removing index on 'SourcePdfToHandle', fields ['lot_number']
        db.delete_index(u'enersectapp_sourcepdftohandle', ['lot_number'])
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
