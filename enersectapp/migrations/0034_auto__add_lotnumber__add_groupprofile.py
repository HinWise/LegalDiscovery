...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LotNumber'
        db.create_table(u'enersectapp_lotnumber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lot_number', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
        ))
        db.send_create_signal(u'enersectapp', ['LotNumber'])

        # Adding model 'GroupProfile'
        db.create_table(u'enersectapp_groupprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Group'], unique=True)),
        ))
        db.send_create_signal(u'enersectapp', ['GroupProfile'])

        # Adding M2M table for field unique_lot_number_list on 'GroupProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_groupprofile_unique_lot_number_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groupprofile', models.ForeignKey(orm[u'enersectapp.groupprofile'], null=False)),
            ('lotnumber', models.ForeignKey(orm[u'enersectapp.lotnumber'], null=False))
        ))
        db.create_unique(m2m_table_name, ['groupprofile_id', 'lotnumber_id'])


    def backwards(self, orm):
        # Deleting model 'LotNumber'
        db.delete_table(u'enersectapp_lotnumber')

        # Deleting model 'GroupProfile'
        db.delete_table(u'enersectapp_groupprofile')

        # Removing M2M table for field unique_lot_number_list on 'GroupProfile'
        db.delete_table(db.shorten_name(u'enersectapp_groupprofile_unique_lot_number_list'))
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
