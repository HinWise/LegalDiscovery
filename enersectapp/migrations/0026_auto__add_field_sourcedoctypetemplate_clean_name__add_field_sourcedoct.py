...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDocTypeTemplate.clean_name'
        db.add_column(u'enersectapp_sourcedoctypetemplate', 'clean_name',
                      self.gf('django.db.models.fields.CharField')(default='uncategorized', max_length=255),
                      keep_default=False)

        # Adding field 'SourceDocType.clean_name'
        db.add_column(u'enersectapp_sourcedoctype', 'clean_name',
                      self.gf('django.db.models.fields.CharField')(default='uncategorized', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDocTypeTemplate.clean_name'
        db.delete_column(u'enersectapp_sourcedoctypetemplate', 'clean_name')

        # Deleting field 'SourceDocType.clean_name'
        db.delete_column(u'enersectapp_sourcedoctype', 'clean_name')
