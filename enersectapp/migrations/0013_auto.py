...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field modifiedsourcepdfs_blank_or_not_tool on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_modifiedsourcepdfs_blank_or_not_tool')
    ...
    def backwards(self, orm):
        # Removing M2M table for field modifiedsourcepdfs_blank_or_not_tool on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_modifiedsourcepdfs_blank_or_not_tool'))
