...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.skip_counter'
        db.add_column(u'enersectapp_pdfrecord', 'skip_counter',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=10),
                      keep_default=False)

        # Adding field 'Record.linked_style_class'
        db.add_column(u'enersectapp_record', 'linked_style_class',
                      self.gf('django.db.models.fields.CharField')(default='nolink', max_length=255),
                      keep_default=False)

        # Adding field 'Record.error_style_class'
        db.add_column(u'enersectapp_record', 'error_style_class',
                      self.gf('django.db.models.fields.CharField')(default='noerror', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.skip_counter'
        db.delete_column(u'enersectapp_pdfrecord', 'skip_counter')

        # Deleting field 'Record.linked_style_class'
        db.delete_column(u'enersectapp_record', 'linked_style_class')

        # Deleting field 'Record.error_style_class'
        db.delete_column(u'enersectapp_record', 'error_style_class')
