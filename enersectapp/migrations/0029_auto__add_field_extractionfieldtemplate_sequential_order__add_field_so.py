...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtractionFieldTemplate.sequential_order'
        db.add_column(u'enersectapp_extractionfieldtemplate', 'sequential_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SourceDocTypeTemplate.sequential_order'
        db.add_column(u'enersectapp_sourcedoctypetemplate', 'sequential_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtractionFieldTemplate.sequential_order'
        db.delete_column(u'enersectapp_extractionfieldtemplate', 'sequential_order')

        # Deleting field 'SourceDocTypeTemplate.sequential_order'
        db.delete_column(u'enersectapp_sourcedoctypetemplate', 'sequential_order')
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
