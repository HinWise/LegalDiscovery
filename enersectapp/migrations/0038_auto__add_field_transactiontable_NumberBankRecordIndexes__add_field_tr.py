...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionTable.NumberBankRecordIndexes'
        db.add_column(u'enersectapp_transactiontable', 'NumberBankRecordIndexes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TransactionTable.InternalRecordListOriginalArray'
        db.add_column(u'enersectapp_transactiontable', 'InternalRecordListOriginalArray',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)

        # Adding field 'TransactionTable.NumberInternalRecordIndexes'
        db.add_column(u'enersectapp_transactiontable', 'NumberInternalRecordIndexes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TransactionTable.Amount'
        db.add_column(u'enersectapp_transactiontable', 'Amount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'TransactionTable.AmountDiscrepancy'
        db.add_column(u'enersectapp_transactiontable', 'AmountDiscrepancy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TransactionTable.PostDay'
        db.add_column(u'enersectapp_transactiontable', 'PostDay',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)

        # Adding field 'TransactionTable.PostMonth'
        db.add_column(u'enersectapp_transactiontable', 'PostMonth',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)

        # Adding field 'TransactionTable.PostYear'
        db.add_column(u'enersectapp_transactiontable', 'PostYear',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)

        # Adding field 'TransactionTable.ValueDay'
        db.add_column(u'enersectapp_transactiontable', 'ValueDay',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)

        # Adding field 'TransactionTable.ValueMonth'
        db.add_column(u'enersectapp_transactiontable', 'ValueMonth',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)

        # Adding field 'TransactionTable.ValueYear'
        db.add_column(u'enersectapp_transactiontable', 'ValueYear',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)

        # Adding field 'TransactionTable.DateDiscrepancy'
        db.add_column(u'enersectapp_transactiontable', 'DateDiscrepancy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TransactionTable.Libdesc'
        db.add_column(u'enersectapp_transactiontable', 'Libdesc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'TransactionTable.Reftran'
        db.add_column(u'enersectapp_transactiontable', 'Reftran',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'TransactionTable.BankAccount'
        db.add_column(u'enersectapp_transactiontable', 'BankAccount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'TransactionTable.BankName'
        db.add_column(u'enersectapp_transactiontable', 'BankName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'TransactionTable.BankCurrency'
        db.add_column(u'enersectapp_transactiontable', 'BankCurrency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding M2M table for field internal_records_list on 'TransactionTable'
        m2m_table_name = db.shorten_name(u'enersectapp_transactiontable_internal_records_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False)),
            ('internalrecord', models.ForeignKey(orm[u'enersectapp.internalrecord'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transactiontable_id', 'internalrecord_id'])


        # Changing field 'TransactionTable.BankRecordsListOriginalArray'
        db.alter_column(u'enersectapp_transactiontable', 'BankRecordsListOriginalArray', self.gf('django.db.models.fields.CharField')(max_length=2047))

    def backwards(self, orm):
        # Deleting field 'TransactionTable.NumberBankRecordIndexes'
        db.delete_column(u'enersectapp_transactiontable', 'NumberBankRecordIndexes')

        # Deleting field 'TransactionTable.InternalRecordListOriginalArray'
        db.delete_column(u'enersectapp_transactiontable', 'InternalRecordListOriginalArray')

        # Deleting field 'TransactionTable.NumberInternalRecordIndexes'
        db.delete_column(u'enersectapp_transactiontable', 'NumberInternalRecordIndexes')

        # Deleting field 'TransactionTable.Amount'
        db.delete_column(u'enersectapp_transactiontable', 'Amount')

        # Deleting field 'TransactionTable.AmountDiscrepancy'
        db.delete_column(u'enersectapp_transactiontable', 'AmountDiscrepancy')

        # Deleting field 'TransactionTable.PostDay'
        db.delete_column(u'enersectapp_transactiontable', 'PostDay')

        # Deleting field 'TransactionTable.PostMonth'
        db.delete_column(u'enersectapp_transactiontable', 'PostMonth')

        # Deleting field 'TransactionTable.PostYear'
        db.delete_column(u'enersectapp_transactiontable', 'PostYear')

        # Deleting field 'TransactionTable.ValueDay'
        db.delete_column(u'enersectapp_transactiontable', 'ValueDay')

        # Deleting field 'TransactionTable.ValueMonth'
        db.delete_column(u'enersectapp_transactiontable', 'ValueMonth')

        # Deleting field 'TransactionTable.ValueYear'
        db.delete_column(u'enersectapp_transactiontable', 'ValueYear')

        # Deleting field 'TransactionTable.DateDiscrepancy'
        db.delete_column(u'enersectapp_transactiontable', 'DateDiscrepancy')

        # Deleting field 'TransactionTable.Libdesc'
        db.delete_column(u'enersectapp_transactiontable', 'Libdesc')

        # Deleting field 'TransactionTable.Reftran'
        db.delete_column(u'enersectapp_transactiontable', 'Reftran')

        # Deleting field 'TransactionTable.BankAccount'
        db.delete_column(u'enersectapp_transactiontable', 'BankAccount')

        # Deleting field 'TransactionTable.BankName'
        db.delete_column(u'enersectapp_transactiontable', 'BankName')

        # Deleting field 'TransactionTable.BankCurrency'
        db.delete_column(u'enersectapp_transactiontable', 'BankCurrency')

        # Removing M2M table for field internal_records_list on 'TransactionTable'
        db.delete_table(db.shorten_name(u'enersectapp_transactiontable_internal_records_list'))


        # Changing field 'TransactionTable.BankRecordsListOriginalArray'
        db.alter_column(u'enersectapp_transactiontable', 'BankRecordsListOriginalArray', self.gf('django.db.models.fields.CharField')(max_length=63))
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
