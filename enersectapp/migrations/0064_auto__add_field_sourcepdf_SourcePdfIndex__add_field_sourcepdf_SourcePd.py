...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourcePdf.SourcePdfIndex'
        db.add_column(u'enersectapp_sourcepdf', 'SourcePdfIndex',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SourcePdf.SourcePdfReference'
        db.add_column(u'enersectapp_sourcepdf', 'SourcePdfReference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'SourcePdf.corpus_type'
        db.add_column(u'enersectapp_sourcepdf', 'corpus_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=31),
                      keep_default=False)

        # Adding field 'SourcePdf.Document_Number'
        db.add_column(u'enersectapp_sourcepdf', 'Document_Number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'SourcePdf.Beneficiary'
        db.add_column(u'enersectapp_sourcepdf', 'Beneficiary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourcePdf.SourcePdfIndex'
        db.delete_column(u'enersectapp_sourcepdf', 'SourcePdfIndex')

        # Deleting field 'SourcePdf.SourcePdfReference'
        db.delete_column(u'enersectapp_sourcepdf', 'SourcePdfReference')

        # Deleting field 'SourcePdf.corpus_type'
        db.delete_column(u'enersectapp_sourcepdf', 'corpus_type')

        # Deleting field 'SourcePdf.Document_Number'
        db.delete_column(u'enersectapp_sourcepdf', 'Document_Number')

        # Deleting field 'SourcePdf.Beneficiary'
        db.delete_column(u'enersectapp_sourcepdf', 'Beneficiary')
