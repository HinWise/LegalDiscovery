...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.modified_doctype_from'
        db.add_column(u'enersectapp_pdfrecord', 'modified_doctype_from',
                      self.gf('django.db.models.fields.CharField')(default='uncategorized', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.modified_doctype_from'
        db.delete_column(u'enersectapp_pdfrecord', 'modified_doctype_from')
