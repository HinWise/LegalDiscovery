...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionTable.GLMemo'
        db.add_column(u'enersectapp_transactiontable', 'GLMemo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)

        # Adding field 'TransactionTable.GLCompany'
        db.add_column(u'enersectapp_transactiontable', 'GLCompany',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=63),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransactionTable.GLMemo'
        db.delete_column(u'enersectapp_transactiontable', 'GLMemo')

        # Deleting field 'TransactionTable.GLCompany'
        db.delete_column(u'enersectapp_transactiontable', 'GLCompany')
