...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntryLinks'
        db.create_table(u'enersectapp_entrylinks', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry_pk', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'enersectapp', ['EntryLinks'])

        # Adding M2M table for field high_candidates_list on 'EntryLinks'
        m2m_table_name = db.shorten_name(u'enersectapp_entrylinks_high_candidates_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entrylinks', models.ForeignKey(orm[u'enersectapp.entrylinks'], null=False)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False))
        ))
        db.create_unique(m2m_table_name, ['entrylinks_id', 'transactiontable_id'])

        # Adding M2M table for field medium_candidates_list on 'EntryLinks'
        m2m_table_name = db.shorten_name(u'enersectapp_entrylinks_medium_candidates_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entrylinks', models.ForeignKey(orm[u'enersectapp.entrylinks'], null=False)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False))
        ...
        # Adding M2M table for field low_candidates_list on 'EntryLinks'
        m2m_table_name = db.shorten_name(u'enersectapp_entrylinks_low_candidates_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entrylinks', models.ForeignKey(orm[u'enersectapp.entrylinks'], null=False)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False))
        ...
        # Adding M2M table for field excluded_candidates_list on 'EntryLinks'
        m2m_table_name = db.shorten_name(u'enersectapp_entrylinks_excluded_candidates_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entrylinks', models.ForeignKey(orm[u'enersectapp.entrylinks'], null=False)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False))
    ...
    def backwards(self, orm):
        # Deleting model 'EntryLinks'
        db.delete_table(u'enersectapp_entrylinks')

        # Removing M2M table for field high_candidates_list on 'EntryLinks'
        db.delete_table(db.shorten_name(u'enersectapp_entrylinks_high_candidates_list'))

        # Removing M2M table for field medium_candidates_list on 'EntryLinks'
        db.delete_table(db.shorten_name(u'enersectapp_entrylinks_medium_candidates_list'))

        # Removing M2M table for field low_candidates_list on 'EntryLinks'
        db.delete_table(db.shorten_name(u'enersectapp_entrylinks_low_candidates_list'))

        # Removing M2M table for field excluded_candidates_list on 'EntryLinks'
        db.delete_table(db.shorten_name(u'enersectapp_entrylinks_excluded_candidates_list'))
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 6, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 6, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 6, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 6, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 6, 0, 0)'}),
