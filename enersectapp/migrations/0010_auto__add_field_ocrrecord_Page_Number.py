...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OcrRecord.Page_Number'
        db.add_column(u'enersectapp_ocrrecord', 'Page_Number',
                      self.gf('django.db.models.fields.CharField')(default='NoPageNumberField', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OcrRecord.Page_Number'
        db.delete_column(u'enersectapp_ocrrecord', 'Page_Number')
