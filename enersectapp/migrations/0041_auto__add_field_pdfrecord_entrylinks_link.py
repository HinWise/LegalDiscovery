...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.entrylinks_link'
        db.add_column(u'enersectapp_pdfrecord', 'entrylinks_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.EntryLinks'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.entrylinks_link'
        db.delete_column(u'enersectapp_pdfrecord', 'entrylinks_link_id')
