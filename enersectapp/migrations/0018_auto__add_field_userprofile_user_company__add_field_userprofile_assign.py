...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_company'
        db.add_column(u'enersectapp_userprofile', 'user_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.assignation_locked'
        db.add_column(u'enersectapp_userprofile', 'assignation_locked',
                      self.gf('django.db.models.fields.CharField')(default='not_locked', max_length=31),
                      keep_default=False)

        # Adding field 'Report.report_subtype'
        db.add_column(u'enersectapp_report', 'report_subtype',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_company'
        db.delete_column(u'enersectapp_userprofile', 'user_company_id')

        # Deleting field 'UserProfile.assignation_locked'
        db.delete_column(u'enersectapp_userprofile', 'assignation_locked')

        # Deleting field 'Report.report_subtype'
        db.delete_column(u'enersectapp_report', 'report_subtype')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)'}),
