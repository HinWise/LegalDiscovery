...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransactionsReportTemplate'
        db.create_table(u'enersectapp_transactionsreporttemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=63)),
            ('searchtag_string', self.gf('django.db.models.fields.CharField')(default='', max_length=511)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 17, 0, 0))),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 17, 0, 0))),
            ('creation_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'enersectapp', ['TransactionsReportTemplate'])

        # Adding M2M table for field selected_transactions on 'TransactionsReportTemplate'
        m2m_table_name = db.shorten_name(u'enersectapp_transactionsreporttemplate_selected_transactions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transactionsreporttemplate', models.ForeignKey(orm[u'enersectapp.transactionsreporttemplate'], null=False)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transactionsreporttemplate_id', 'transactiontable_id'])

        # Adding M2M table for field created_transactionsreport_templates on 'UserProfile'
        m2m_table_name = db.shorten_name(u'enersectapp_userprofile_created_transactionsreport_templates')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'enersectapp.userprofile'], null=False)),
            ('transactionsreporttemplate', models.ForeignKey(orm[u'enersectapp.transactionsreporttemplate'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'transactionsreporttemplate_id'])


    def backwards(self, orm):
        # Deleting model 'TransactionsReportTemplate'
        db.delete_table(u'enersectapp_transactionsreporttemplate')

        # Removing M2M table for field selected_transactions on 'TransactionsReportTemplate'
        db.delete_table(db.shorten_name(u'enersectapp_transactionsreporttemplate_selected_transactions'))

        # Removing M2M table for field created_transactionsreport_templates on 'UserProfile'
        db.delete_table(db.shorten_name(u'enersectapp_userprofile_created_transactionsreport_templates'))
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 17, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 17, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 17, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 17, 0, 0)'}),
