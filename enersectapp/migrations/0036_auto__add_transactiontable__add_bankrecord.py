...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransactionTable'
        db.create_table(u'enersectapp_transactiontable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('TransactionIndex', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'enersectapp', ['TransactionTable'])

        # Adding M2M table for field bank_records_list on 'TransactionTable'
        m2m_table_name = db.shorten_name(u'enersectapp_transactiontable_bank_records_list')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transactiontable', models.ForeignKey(orm[u'enersectapp.transactiontable'], null=False)),
            ('bankrecord', models.ForeignKey(orm[u'enersectapp.bankrecord'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transactiontable_id', 'bankrecord_id'])

        # Adding model 'BankRecord'
        db.create_table(u'enersectapp_bankrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('BankRecordIndex', self.gf('django.db.models.fields.IntegerField')()),
            ('TransactionIndex', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('BankAccount', self.gf('django.db.models.fields.CharField')(max_length=31)),
            ('BankName', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('BankCurrency', self.gf('django.db.models.fields.CharField')(max_length=31)),
            ('PostDay', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('PostMonth', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('PostYear', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('ValueDay', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('ValueMonth', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('ValueYear', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('Libelle', self.gf('django.db.models.fields.CharField')(max_length=31)),
            ('Reference', self.gf('django.db.models.fields.CharField')(max_length=31)),
            ('Amount', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('Description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('TransactionId', self.gf('django.db.models.fields.CharField')(max_length=31)),
            ('Libdesc', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('Reftran', self.gf('django.db.models.fields.CharField')(max_length=31)),
            ('Provenance', self.gf('django.db.models.fields.CharField')(max_length=31)),
        ))
        db.send_create_signal(u'enersectapp', ['BankRecord'])


    def backwards(self, orm):
        # Deleting model 'TransactionTable'
        db.delete_table(u'enersectapp_transactiontable')

        # Removing M2M table for field bank_records_list on 'TransactionTable'
        db.delete_table(db.shorten_name(u'enersectapp_transactiontable_bank_records_list'))

        # Deleting model 'BankRecord'
        db.delete_table(u'enersectapp_bankrecord')
    ...
    models = {
        ...
        u'enersectapp.extractionfieldtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed'", 'max_length': '127'}),
            'pretty_name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '127'}),
            'real_field_name': ('django.db.models.fields.CharField', [], {'default': "'NeedsInput'", 'max_length': '127'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
