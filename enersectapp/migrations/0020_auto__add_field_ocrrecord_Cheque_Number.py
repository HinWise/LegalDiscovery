...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OcrRecord.Cheque_Number'
        db.add_column(u'enersectapp_ocrrecord', 'Cheque_Number',
                      self.gf('django.db.models.fields.CharField')(default='NoChequeNumberField', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OcrRecord.Cheque_Number'
        db.delete_column(u'enersectapp_ocrrecord', 'Cheque_Number')
    ...
    models = {
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 0, 0)'}),
            'modified_doctype_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 0, 0)'}),
