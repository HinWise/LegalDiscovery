...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExtractionFieldTemplate.general_sorting'
        db.delete_column(u'enersectapp_extractionfieldtemplate', 'general_sorting')

        # Adding field 'SourceDocTypeTemplate.extraction_fields_sorting'
        db.add_column(u'enersectapp_sourcedoctypetemplate', 'extraction_fields_sorting',
        ...
        # Adding field 'SourceDocType.extraction_fields_sorting'
        db.add_column(u'enersectapp_sourcedoctype', 'extraction_fields_sorting',
                      self.gf('django.db.models.fields.CharField')(default='importance', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExtractionFieldTemplate.general_sorting'
        db.add_column(u'enersectapp_extractionfieldtemplate', 'general_sorting',
                      self.gf('django.db.models.fields.CharField')(default='modification_date', max_length=31),
                      keep_default=False)

        # Deleting field 'SourceDocTypeTemplate.extraction_fields_sorting'
        db.delete_column(u'enersectapp_sourcedoctypetemplate', 'extraction_fields_sorting')
        ...
        # Deleting field 'SourceDocType.extraction_fields_sorting'
        db.delete_column(u'enersectapp_sourcedoctype', 'extraction_fields_sorting')
