...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PdfRecord.audit_mark'
        db.add_column(u'enersectapp_pdfrecord', 'audit_mark',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PdfRecord.audit_mark'
        db.delete_column(u'enersectapp_pdfrecord', 'audit_mark')
