...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OcrRecord.OcrRecordIndex'
        db.add_column(u'enersectapp_ocrrecord', 'OcrRecordIndex',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'OcrRecord.CompanyLineIndex'
        db.add_column(u'enersectapp_ocrrecord', 'CompanyLineIndex',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=15),
                      keep_default=False)

        # Adding field 'OcrRecord.OldCompanyLine'
        db.add_column(u'enersectapp_ocrrecord', 'OldCompanyLine',
                      self.gf('django.db.models.fields.CharField')(default='MISSING NAME', max_length=255),
                      keep_default=False)

        # Adding field 'OcrRecord.actual_affidavit_watermark'
        db.add_column(u'enersectapp_ocrrecord', 'actual_affidavit_watermark',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enersectapp.AffidavitInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OcrRecord.affidavit_watermark_string'
        db.add_column(u'enersectapp_ocrrecord', 'affidavit_watermark_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=7),
                      keep_default=False)

        # Adding field 'OcrRecord.affidavit_uid_string'
        db.add_column(u'enersectapp_ocrrecord', 'affidavit_uid_string',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=63),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OcrRecord.OcrRecordIndex'
        db.delete_column(u'enersectapp_ocrrecord', 'OcrRecordIndex')

        # Deleting field 'OcrRecord.CompanyLineIndex'
        db.delete_column(u'enersectapp_ocrrecord', 'CompanyLineIndex')

        # Deleting field 'OcrRecord.OldCompanyLine'
        db.delete_column(u'enersectapp_ocrrecord', 'OldCompanyLine')

        # Deleting field 'OcrRecord.actual_affidavit_watermark'
        db.delete_column(u'enersectapp_ocrrecord', 'actual_affidavit_watermark_id')

        # Deleting field 'OcrRecord.affidavit_watermark_string'
        db.delete_column(u'enersectapp_ocrrecord', 'affidavit_watermark_string')

        # Deleting field 'OcrRecord.affidavit_uid_string'
        db.delete_column(u'enersectapp_ocrrecord', 'affidavit_uid_string')
    ...
    models = {
        ...
        u'enersectapp.affidavitinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
        ...
        u'enersectapp.legaldiscoverytemplate': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
            'creation_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'enersectapp.ocrrecord': {
            ...
            'Company': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'CompanyLineIndex': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '15'}),
        ...
        u'enersectapp.pdfrecord': {
            ...
            'modified_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
        ...
        u'enersectapp.report': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
        ...
        u'enersectapp.sourcepdf': {
            ...
            'modification_doctype_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
