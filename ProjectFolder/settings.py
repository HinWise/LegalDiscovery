...
if socket.gethostname() == 'Nemot1':
    ...
    database_path = 'C:/Dropbox/GitHub/LegalDiscovery/databases/nathansqlite3db'
    template_dirs = 'C:/Dropbox/GitHub/LegalDiscovery/templates'
...
if socket.gethostname() == 'Nemot-PC':
    ...
    database_path = 'F:/Nath_Database/ProjectFolder/databases/nathansqlite3db'
...
MAINTENANCE_FILE = '/srv/enersectapp/app/ProjectFolder/enersectapp/templates/enersectapp/maintenance_screen.jpg' 

MAINTENANCE_URL = '/enersectapp/maintenance_screen'
...
AUTH_PROFILE_MODULE = 'enersectapp.UserProfile'
